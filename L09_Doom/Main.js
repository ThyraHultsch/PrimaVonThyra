...
(function (L10_Doom_Mouse) {
    ...
    let walls;
    let ctrSpeed = new fc.Control("AvatarSpeed", 0.4, 0 /* PROPORTIONAL */);
    ctrSpeed.setDelay(100);
    let ctrSpeed2 = new fc.Control("AvatarSpeed2", 0.1, 0 /* PROPORTIONAL */);
    ctrSpeed2.setDelay(100);
    let ctrRotation = new fc.Control("AvatarRotation", -0.1, 0 /* PROPORTIONAL */);
    ctrRotation.setDelay(50);
    let previousMouseMovement = 0;
    ...
    function hndLoop(_event) {
        ...
        ctrSpeed2.setInput(fc.Keyboard.mapToValue(0, -1, [fc.KEYBOARD_CODE.A, ƒ.KEYBOARD_CODE.ARROW_LEFT])
    ...
    function moveAvatar(_translation, _translation2, _rotation) {
    ...
    function createWalls() {
        ...
        walls.appendChild(new L10_Doom_Mouse.Wall(fc.Vector2.ONE(3), fc.Vector3.SCALE(new fc.Vector3(0.5, 1, -0.866), sizeWall / 2), fc.Vector3.Y(120), mtrWall));
        walls.appendChild(new L10_Doom_Mouse.Wall(fc.Vector2.ONE(3), fc.Vector3.SCALE(new fc.Vector3(-0.5, 1, -0.866), sizeWall / 2), fc.Vector3.Y(-120), mtrWall));
